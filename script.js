...
const translations = {
    ...
    en: {
        ...
        turkmenistanText1: "Export of petroleum products from Turkmenistan is carried out exclusively through the State Commodity and Raw Materials Exchange of Turkmenistan (SRCMET).",
        turkmenistanText2: "Transactions with Turkmen origin are regulated by:",
        turkmenistanText3: "All products and available volumes are published on the SRCMET website, ensuring transparency for foreign buyers.",
        ...
        turkmenistanText9: "We do not guarantee volume distribution, do not influence auction results, and do not support transactions outside the SRCMET exchange model.",

        turkmenistanList1: "legislation of Turkmenistan",
        turkmenistanList2: "SRCMET rules and regulations",
        turkmenistanList3: "conditions and procedures established by the seller within exchange trading",
        turkmenistanList4: "a foreign company must be registered at SRCMET",
        ...
        turkmenistanList8: "supporting registration and access to trading on SRCMET",
        ...
        turkmenistanDeals3: "Account for publication of quotes on SRCMET website",
        ...
        turkmenistanDeals5: "For transactions originating in Turkmenistan, you must be prepared to participate in the exchange procedure, make advance payments, and take into account the publication of quotes on the SRCMET website.",
        ...
        globalText: "Export of petroleum products from Turkmenistan is carried out exclusively through the State Commodity and Raw Materials Exchange of Turkmenistan (SRCMET).",
