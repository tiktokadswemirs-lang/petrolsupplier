...
const translations = {
    ru: {
        ...
        globalText: "Мы ежедневно осуществляем торговые операции по поставкам нефтепродуктов в различных регионах мира.",
        globalHighlight1: "🌍 Глобальное присутствие на ключевых рынках",
        globalHighlight2: "Наша сеть охватывает основные торговые маршруты",
    ...
    en: {
        ...
        turkmenistanText3: "All products and available volumes are published on the GTSBT website, ensuring transparency.",
        turkmenistanText4: "International trade procedures (SOP, ICC, UCP 600) do not apply to the Turkmenistan exchange model. Only Incoterms are used.",
        turkmenistanText5: "All transactions are prepayment only:",
        turkmenistanText6: "The transaction procedure and payment terms are fully determined by the seller and the exchange.",
        turkmenistanText7: "We do not represent Turkmenistan refineries and do not hold seller mandates.",
        turkmenistanText8: "Our role is limited to supporting the buyer side, including:",
        turkmenistanText9: "We do not guarantee volume allocation and do not influence auction results.",

        turkmenistanList1: "legislation of Turkmenistan",
        turkmenistanList2: "GTSBT rules and regulations",
        turkmenistanList3: "conditions set by the seller",
        turkmenistanList4: "foreign company must be registered at GTSBT",
        turkmenistanList5: "settlements only after registration",
        turkmenistanList6: "payment procedure is defined by the seller",
        turkmenistanList7: "explaining the exchange model",
        turkmenistanList8: "registration support",
        turkmenistanList9: "document coordination",
        turkmenistanList10: "adapting buyer expectations",
        turkmenistanList11: "document compliance control",
        ...
        globalTitle: "Worldwide operations",
        globalText: "We conduct daily trading operations for the supply of petroleum products in various regions of the world.",
        globalHighlight1: "🌍 Global presence in key markets",
        globalHighlight2: "Our network covers major trade routes",
    ...
    tr: {
        ...
        turkmenistanText3: "Tüm ürünler ve mevcut hacimler GTSBT web sitesinde yayınlanır, bu da şeffaflık sağlar.",
        turkmenistanText4: "Türkmenistan borsa modelinde uluslararası ticaret prosedürleri (SOP, ICC, UCP 600) uygulanmaz. Sadece teslimat şekli için Incoterms kullanılır.",
        turkmenistanText5: "Tüm işlemler ön ödemelidir:",
        turkmenistanText6: "İşlem prosedürü ve ödeme şekli tamamen satıcı ve borsa tarafından belirlenir.",
        turkmenistanText7: "Türkmenistan rafinerilerini temsil etmiyoruz ve satıcı yetkisine sahip değiliz.",
        turkmenistanText8: "Rolümüz alıcı tarafına eşlik etmekle sınırlıdır ve şunları içerir:",
        turkmenistanText9: "Hacim dağılımını garanti etmiyoruz ve ihale sonuçlarını etkilemiyoruz.",

        turkmenistanList1: "Türkmenistan mevzuatı",
        turkmenistanList2: "GTSBT kuralları ve yönetmelikleri",
        turkmenistanList3: "satıcı tarafından belirlenen şartlar",
        turkmenistanList4: "yabancı şirket GTSBT'ye kayıtlı olmalıdır",
        turkmenistanList5: "ödemeler sadece kayıttan sonra yapılır",
        turkmenistanList6: "ödeme prosedürü satıcı tarafından belirlenir",
        turkmenistanList7: "borsa modelinin açıklanması",
        turkmenistanList8: "kayıt desteği",
        turkmenistanList9: "belge koordinasyonu",
        turkmenistanList10: "alıcı beklentilerinin uyarlanması",
        turkmenistanList11: "belge uygunluk kontrolü",
        ...
        globalTitle: "Dünya çapında operasyonlar",
        globalText: "Dünyanın çeşitli bölgelerine petrol ürünleri tedariki için günlük ticaret operasyonları gerçekleştiriyoruz.",
        globalHighlight1: "🌍 Ana pazarlarda küresel varlık",
        globalHighlight2: "Ağımız tüm ana ticaret yollarını kapsar",
